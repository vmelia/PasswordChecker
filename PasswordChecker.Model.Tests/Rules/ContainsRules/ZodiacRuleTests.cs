...
public class ZodiacRuleTests : TestBase
{
    public ZodiacRuleTests() : base(new ZodiacRule()) { }
    ...
    public void ErrorText_WhenEmptyPassword_ReturnsCorrectText()
    {
        ...
        Assert.Equal("Password must contain a sign of the Zodiac", ruleResult.Message);
    }
